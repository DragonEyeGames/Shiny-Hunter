...
class SwScreen(ctk.CTkFrame):
    ...
    def create_pokemon_button(self, x, y, image, name, boot_screen, disabled=False):
        ...
        button = ctk.CTkButton(self, image=image, text="", width=80, border_spacing=0, fg_color="#5e5e5e", bg_color="#21344a", hover_color="#bfbfbf", border_width=3, border_color="black", command=lambda: self.start_hunt(name,boot_screen))
