...
class SwScreen(ctk.CTkFrame):
    ...
    def __init__(self, parent, back_callback, boot_screen, egg_screen):
        ...
        # Outline box
        self.color_box = ctk.CTkFrame(self,fg_color="#21344a",width=608,height=257,corner_radius=15, border_width=5, border_color="black")

        self.color_box.place(x=96,y=156)
        ...
        self.create_pokemon_button(400,160,self.regieleki,"Regieleki",boot_screen)
        self.create_pokemon_button(500,160,self.regidrago,"Regidrago",boot_screen)
        self.create_pokemon_button(600,160,self.regigigas,"Regigigas",boot_screen)
        ...
        # Back button
        back_button = ctk.CTkButton(self,text="Back",font=("Basic",25),width=100,height=40,fg_color="#C0392B",hover_color="#96281B",border_color="black",border_width=3,command=back_callback, corner_radius=10)
    ...
    def create_pokemon_button(self, x, y, image, name, boot_screen, disabled=False):
        ...
        label = ctk.CTkLabel(self, text=name, font=("Basic",11), text_color="black", fg_color="white", bg_color="#5e5e5e", width=74, height=20, corner_radius=5, border_width=2, border_color="black")
        label.place(x=x+13, y=y+73)
