...
class SwScreen(ctk.CTkFrame):
    ...
    def create_pokemon_button(self, x, y, image, name, boot_screen, disabled=False):
        ...
        button = ctk.CTkButton(self, image=image, text="", width=1, height=80, border_spacing=0, fg_color="#5e5e5e", bg_color="#21344a", hover_color="#bfbfbf", command=lambda: self.start_hunt(name,boot_screen))
        ...
        label_box = ctk.CTkFrame(self, fg_color="black", bg_color="#5e5e5e", width=1, height=18, corner_radius=5)
        ...
        label = ctk.CTkLabel(master=label_box, text=name, font=("Arial",11), text_color="black", fg_color="white", width=1, height=18, corner_radius=3)
        label.place(x=1, y=1)
